        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblCourseEnquiry>(entity =>
            {
                entity.HasKey(e => e.CourseEnquiryId)
                    .HasName("PK__TblCours__9B00A0CE3356653B");
                ...
                entity.HasOne(d => d.Course)
                    ...
                    .HasForeignKey(d => d.CourseId)
                    .HasConstraintName("FK__TblCourse__Cours__4AB81AF0");

                entity.HasOne(d => d.Lead)
                    .WithMany(p => p.TblCourseEnquiry)
                    .HasForeignKey(d => d.LeadId)
                    .HasConstraintName("FK__TblCourse__LeadI__4BAC3F29");
            });

            modelBuilder.Entity<TblLead>(entity =>
            {
                entity.HasKey(e => e.LeadId)
                    .HasName("PK__TblLead__73EF78FA5A90DD81");
            ...
            modelBuilder.Entity<TblResourceEnquiry>(entity =>
            {
                entity.HasKey(e => e.ResourceEnquiryId)
                    .HasName("PK__TblResou__BA357E0FEFF9EA12");
                ...
                entity.HasOne(d => d.Lead)
                    ...
                    .HasForeignKey(d => d.LeadId)
                    .HasConstraintName("FK__TblResour__LeadI__4F7CD00D");

                entity.HasOne(d => d.Resource)
                    .WithMany(p => p.TblResourceEnquiry)
                    .HasForeignKey(d => d.ResourceId)
                    .HasConstraintName("FK__TblResour__Resou__4E88ABD4");
            });
            ...
            modelBuilder.Entity<TblSalesPipeline>(entity =>
            {
                entity.HasKey(e => e.SalesPipelineId)
                    .HasName("PK__TblSales__EC8BF14EFA26D4DB");
                ...
                entity.HasOne(d => d.Lead)
                    ...
                    .HasForeignKey(d => d.LeadId)
                    .HasConstraintName("FK__TblSalesP__LeadI__52593CB8");
            });

            modelBuilder.Entity<TblTrainee>(entity =>
            {
                entity.HasKey(e => e.TraineeId)
                    .HasName("PK__TblTrain__3BA911CADFF610D3");

                entity.HasOne(d => d.Batch)
                    .WithMany(p => p.TblTrainee)
                    .HasForeignKey(d => d.BatchId)
                    .HasConstraintName("FK__TblTraine__Batch__47DBAE45");

                entity.HasOne(d => d.Lead)
                    .WithMany(p => p.TblTrainee)
                    .HasForeignKey(d => d.LeadId)
                    .HasConstraintName("FK__TblTraine__LeadI__46E78A0C");
            });
